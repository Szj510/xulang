...
void main() {
  test('writes template files with xulang exhibition template name', () async {
    ...
    expect(template.path, endsWith('xulang-Summer_Walk_2026-template.json'));
    expect(
