...
<p align="center">
  ...
  <a href="https://github.com/Szj510/xulang/releases/latest"><img alt="Release v1.3.0" src="docs/media/release-badge.svg"></a>
...
```bash
gh attestation verify xulang-v1.3.0-android-arm64-v8a.apk --repo Szj510/xulang
```
