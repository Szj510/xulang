...
<p align="center">
  ...
  <a href="https://github.com/Szj510/xulang/releases/latest"><img alt="Release v1.4.1" src="docs/media/release-badge.svg"></a>
...
- **Android 录屏**：用户主动授权后生成 MP4，尽量同时录入应用内背景音乐；录屏功能目前仅支持 Android。
...
```bash
gh attestation verify xulang-v1.4.1-android-arm64-v8a.apk --repo Szj510/xulang
```
...
- **Android recording:** create MP4 recordings after explicit system consent, including in-app background music when available; built-in recording is Android-only.
